...
var O = 0, B = I.getSliderOffset(e(o[0]), "x");
e(o).each(function(e) {
I.getSliderOffset(this, "x") > B && (B = I.getSliderOffset(this, "x"), O = e);
});
var D = $[w] - f[O];
I.setSliderOffset(e(o)[O], D), p.splice(0, 0, -1 * D + v), p.splice(p.length - 1, 1), 
...
var M = I.getSliderOffset(t, "x"), L = new Array(), D = new Array(), O = 0, B = 25 / 1024 * c;
frictionCoefficient = E.frictionCoefficient, elasticFrictionCoefficient = E.elasticFrictionCoefficient, 
snapFrictionCoefficient = E.snapFrictionCoefficient, a > E.snapVelocityThreshold && E.snapToChildren && !y ? O = 1 :a < -1 * E.snapVelocityThreshold && E.snapToChildren && !y && (O = -1), 
-1 * B > a ? a = -1 * B :a > B && (a = B), e(t)[0] !== e(b)[0] && (O = -1 * O, a = -2 * a);
var A = T[f];
...
0 > O && !V ? (G++, G >= h.length && !E.infiniteSlider && (G = h.length - 1)) :O > 0 && !V && (G--, 
...
for (var O = 0; O < D.length; O++) Math.abs(D[O] - $) < Math.abs(E) && (E = D[O] - $);
}
0 > E && -1 == M ? E += e(o).width() :E > 0 && 1 == M && (E -= e(o).width());
var B, A, H = new Array();
I.showScrollbar(b, a);
for (var O = 0; _ >= O; O++) B = O, B /= _, B--, A = $ + E * (Math.pow(B, 5) + 1), 
H[H.length] = A;
for (var N = (t + T[m] + w) % w, j = 0, O = 0; O < H.length; O++) if ((0 == O || Math.abs(H[O] - j) > 1 || O >= H.length - 2) && (j = H[O], 
r[O] = I.slowScrollHorizontalIntervalTimer(i * (O + 1), o, n, H[O], a, s, l, c, u, d, t, g, p, f, w, h, m, v, N, b)), 
0 == O && "" != b.onSlideStart) {
var z = (S[m] + T[m] + w) % w;
b.onSlideStart(new I.args("start", b, o, e(o).children(":eq(" + z + ")"), z, t));
}
var P = !1;
b.infiniteSlider ? N != x[m] && (P = !0) :t != S[m] && (P = !0), P && "" != b.onSlideComplete && (r[r.length] = I.onSlideCompleteTimer(i * (O + 1), b, o, e(o).children(":eq(" + N + ")"), N, m)), 
k[m] = r, I.hideScrollbar(b, r, O, H, a, s, l, u, d, m), I.autoSlide(o, n, r, a, s, l, c, u, d, g, p, h, m, f, w, v, b);
},
...
var D, O, B = t - E, A = new Array();
I.showScrollbar(b, a);
for (var H = 0; _ >= H; H++) D = H, D /= _, D--, O = E + B * (Math.pow(D, 5) + 1), 
A[A.length] = O;
...
O = "" != g.scrollbarContainer ? e(g.scrollbarContainer).width() :N, B = N / mt * (O - z), 
...
}), I.setSliderOffset(e("." + J + " ." + Q), Math.floor((-1 * R[S[c]] - $[c] + K) / (C[c] - $[c] + K) * (O - z - B))), 
e("." + J).css({
display:"block"
...
_t = o.type + ".iosSliderEvent", I.changeSlide(t, at, Y, h, Q, B, N, O, z, P, tt, R, W, c, U, st, K, g);
});
...
var o = (S[c] + T[c] + st) % st;
(o > 0 || g.infiniteSlider) && I.changeSlide(o - 1, at, Y, h, Q, B, N, O, z, P, tt, R, W, c, U, st, K, g);
...
_t = t.type + ".iosSliderEvent";
var o = (S[c] + T[c] + st) % st;
(o < R.length - 1 || g.infiniteSlider) && I.changeSlide(o + 1, at, Y, h, Q, B, N, O, z, P, tt, R, W, c, U, st, K, g);
...
"touchstart" == t.type ? e(this).unbind("click.iosSliderEvent") :e(this).unbind("touchstart.iosSliderEvent"), 
_t = t.type + ".iosSliderEvent", pt ? (I.autoSlide(at, Y, h, Q, B, N, O, z, P, tt, R, W, c, U, st, K, g), 
pt = !1, e(g.autoSlideToggleSelector).removeClass("on")) :(I.autoSlidePause(c), 
pt = !0, e(g.autoSlideToggleSelector).addClass("on"));
})), I.autoSlide(at, Y, h, Q, B, N, O, z, P, tt, R, W, c, U, st, K, g), e(X).bind("mouseleave.iosSliderEvent", function() {
return pt ? !0 :(I.autoSlide(at, Y, h, Q, B, N, O, z, P, tt, R, W, c, U, st, K, g), 
void 0);
...
var v, D, O, B, A, H, N, j, z, P, F, R, Y, q, W, U, V = new Array(0, 0), G = new Array(0, 0), J = "scrollbarBlock" + t, Q = "scrollbar" + t, K = 0, X = e(this), Z = !0, et = -1, tt = (new Array(), 
...
e.preventDefault();
var t = (S[c] + T[c] + st) % st;
(t > 0 || g.infiniteSlider) && I.changeSlide(t - 1, at, Y, h, Q, B, N, O, z, P, tt, R, W, c, U, st, K, g);
} else if (39 == e.keyCode && g.keyboardControls || 9 == e.keyCode && g.tabToAdvance) {
e.preventDefault();
var t = (S[c] + T[c] + st) % st;
(t < R.length - 1 || g.infiniteSlider) && I.changeSlide(t + 1, at, Y, h, Q, B, N, O, z, P, tt, R, W, c, U, st, K, g);
}
}), a || g.desktopClickDrag) {
var It = !1, Lt = !1, Dt = e(at), Ot = e(at), Bt = !1;
g.scrollbarDrag && (Dt = Dt.add(v), Ot = Ot.add(D)), e(Dt).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent", function(t) {
if (e(window).one("scroll.iosSliderEvent", function() {
It = !1;
}), It) return !0;
if (It = !0, Lt = !1, "touchstart" == t.type ? e(Ot).unbind("mousedown.iosSliderEvent") :e(Ot).unbind("touchstart.iosSliderEvent"), 
...
e("." + Q).css({
width:B - P + "px"
})) :i < -1 * C[c] && (i = -1 * C[c], I.setSliderOffset(e("." + Q), O - z - B), 
e("." + Q).css({
width:B - P + "px"
}));
...
lt && !bt) {
var l = I.getSliderOffset(at, "x"), h = e(ht)[0] === e(v)[0] ? $[c] :K, m = e(ht)[0] === e(v)[0] ? ($[c] - C[c] - K) / (O - z - B) :1, f = e(ht)[0] === e(v)[0] ? g.scrollbarElasticPullResistance :g.elasticPullResistance, w = g.snapSlideCenter && e(ht)[0] === e(v)[0] ? 0 :K, b = g.snapSlideCenter && e(ht)[0] === e(v)[0] ? K :0;
...
I.showScrollbar(g, Q), r = Math.floor((nt - eventX - i - $[c] + w) / (C[c] - $[c] + K) * (O - z - B) * m);
var j = B;
0 >= r ? (j = B - P - -1 * r, I.setSliderOffset(e("." + Q), 0), e("." + Q).css({
width:j + "px"
})) :r >= O - z - P - B ? (j = O - z - P - r, I.setSliderOffset(e("." + Q), r), 
e("." + Q).css({
width:j + "px"
...
if (Bt) return !0;
if (0 != e.touches.length) for (var t = 0; t < e.touches.length; t++) e.touches[t].pageX == F && I.slowScrollHorizontal(at, Y, h, Q, o, n, B, N, O, z, P, tt, R, W, c, U, st, ht, yt, K, g); else I.slowScrollHorizontal(at, Y, h, Q, o, n, B, N, O, z, P, tt, R, W, c, U, st, ht, yt, K, g);
return bt = !1, It = !1, !0;
...
I.slowScrollHorizontal(dt, Y, h, Q, o, n, B, N, O, z, P, tt, R, W, c, U, st, ht, yt, K, g), 
dt = void 0;
}
bt = !1, It = !1;
});
